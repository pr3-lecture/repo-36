...
class AboutRegularExpressions < Neo::Koan
  ...
  #RubyDoc -> Repetition is greedy by default: as many occurrences as possible are matched
  #while still allowing the overall match to succeed.By contrast, lazy matching makes the minimal amount of
  #matches necessary for overall success. A greedy metacharakter can be lazy by following it with ?.
  #greedy -> having matched they refuse to "give up".
  ...
  def test_variables_can_also_be_used_to_access_captures
    ...
    # "The colon in "Name:" does not match the word.
...
# sub -> find the word the starts with t and replace it with the first letter of the given word? ($1[0,1])
# $1 -> variable to access captures
